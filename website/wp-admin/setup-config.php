...
<?php
	...
	if ( preg_match( '|[^a-z0-9_]|i', $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>CHYBA</strong>: "Předpona databázových tabulek" (prefix) může obsahovat pouze písmena, číslice a podtržítka.'/*/WP_I18N_BAD_PREFIX*/ );
