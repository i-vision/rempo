...
if ( file_exists( ABSPATH . 'wp-config.php') ) {
	...
	wp_die(sprintf(/*WP_I18N_NO_CONFIG*/'<p>Pravděpodobně ještě nebyl vytvořen soubor <code>wp-config.php</code>. Než začnete s WordPressem pracovat, musíte tento soubor nejdříve vytvořit.</p> <p>Nevíte jak? <a href=\'http://codex.wordpress.org/Editing_wp-config.php\'>Podrobnosti naleznete v manuálu</a> (anglicky).</p> <p>Soubor <code>wp-config.php</code> můžete zkusit vytvořit přímo prostřednictvím webového rozhraní, ale tato možnost nemusí fungovat na všech konfiguracích hostingových serverů. Nejbezpečnějším způsobem je ruční vytvoření tohoto souboru.</p><p><a href=\'%ssetup-config.php\' class=\'button\'>Vytvořit konfigurační soubor</a></p>'/*/WP_I18N_NO_CONFIG*/, $path), /*WP_I18N_ERROR_TITLE*/'WordPress &rsaquo; Chyba'/*/WP_I18N_ERROR_TITLE*/, array('text_direction' => $text_direction));
