...
function is_blog_installed() {
	...
	foreach ( $wp_tables as $table ) {
		...
		// Die with a DB error.
		$wpdb->error = sprintf( /*WP_I18N_NO_TABLES*/'Minimálně jedna databázová tabulka není dostupná. Pravděpodobně bude potřeba databázi <a href="%s">opravit</a>.'/*/WP_I18N_NO_TABLES*/, 'maint/repair.php?referrer=is_blog_installed' );
		dead_db();
	}
...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title><?php echo /*WP_I18N_DB_ERROR*/'Chyba databáze'/*/WP_I18N_DB_ERROR*/; ?></title>

</head>
<body>
	<h1><?php echo /*WP_I18N_DB_CONNECTION_ERROR*/'Během připojování k databázovému serveru došlo k nečekané chybě'/*/WP_I18N_DB_CONNECTION_ERROR*/; ?></h1>
</body>
</html>
<?php
	die();
